...
# Apple
ggplot(data = aapl)+
  geom_line(aes(x=as.Date(date), y= as.numeric(AAPL.Close)))+
  scale_x_date(date_breaks = "6 months", date_labels = "%m-%d-%Y")+
  labs(x = 'Date', y = 'Closing Value', title = 'Apple Stock')+
  geom_vline(aes(xintercept =as.Date("yyyy-mm-dd")), color = 'red')

# Amazon
ggplot(data = amzn)+
  geom_line(aes(x=as.Date(date), y=as.numeric(AMZN.Close)))+
  scale_x_date(date_breaks = "6 months", date_labels = "%m-%d-%Y")+
...
ggplot()+
  ...
  geom_vline(aes(xintercept =as.Date("2106-12-22")), color = 'red')+ # 1 of of the 2016 isnt displaying. or theyre too close.
  geom_vline(aes(xintercept =as.Date("2016-12-06")), color = 'red')+
  geom_vline(aes(xintercept =as.Date("2014-03-20")), color = 'red')

# Facebook
ggplot(data = fb)+
  geom_line(aes(x=as.Date(date), y=as.numeric(FB.Close)))+
  scale_x_date(date_breaks = "6 months", date_labels = "%m-%d-%Y")+
  labs(x = 'Date', y = 'Closing Value', 'Facebook Stock')+
  geom_vline(aes(xintercept =as.Date("yyyy-mm-dd")), color = 'red')
...
# Macy's
ggplot(data = macys)+
  geom_line(aes(x=as.Date(date), y=as.numeric(FDO.F.Close)))+
  scale_x_date(date_breaks = "6 months", date_labels = "%m-%d-%Y")+
...
# Google
ggplot(data = goog)+
  geom_line(aes(x=as.Date(date), y=as.numeric(GOOG.Close)))+
  scale_x_date(date_breaks = "6 months", date_labels = "%m-%d-%Y")+
...
# New Yort Times
ggplot(data = nyt)+
  geom_line(aes(x=as.Date(date), y=as.numeric(NYT.Close)))+
  scale_x_date(date_breaks = "6 months", date_labels = "%m-%d-%Y")+
